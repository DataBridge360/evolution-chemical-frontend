...
import { ReportForm } from '@/src/modules/informes/gases-disueltos/components/ReportForm';
import { ReportPreview } from '@/src/modules/informes/gases-disueltos/components/ReportPreview';
import {
  gasesDisueltosReportSchema,
  type GasesDisueltosReportFormData,
} from '@/src/modules/informes/gases-disueltos/types';
import {
  EMPTY_GAS_SAMPLING_POINT,
  DEFAULT_ANALYSIS_TEXT,
} from '@/src/modules/informes/gases-disueltos/constants';
import { serializeGasesDisueltosForApi } from '@/src/modules/informes/gases-disueltos/utils';
import {
  useCreateGasesDisueltosReport,
...
export default function GasesDisueltosPage() {
  ...
  const {
    ...
    control,
    formState: { errors },
  } = useForm<GasesDisueltosReportFormData>({
    resolver: zodResolver(gasesDisueltosReportSchema),
    defaultValues: {
      ...
      sampling_points: [{ ...EMPTY_GAS_SAMPLING_POINT }],
    },
  });
  ...
  const createMutation = useCreateGasesDisueltosReport();
  ...
  const onSave = handleSubmit(async (data) => {
    ...
    const payload = serializeGasesDisueltosForApi(data);
    try {
...
<body>
  ...
  const onViewHistoric = () => {
    ...
    router.push(
      `/analisis/${encodeURIComponent(localidad)}/${encodeURIComponent(companyId)}/informes-gases-disueltos`,
    );
  };
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex items-center justify-between border-b border-[#e5e5e5] px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-semibold text-[#0a0a0a]">Informe Gases Disueltos</h1>
