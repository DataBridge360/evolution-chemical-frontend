    ...
    >
      ...
      {error ? (
        <>
          {error.message}
          <a
            className="relative -ml-1 flex items-center gap-0.5 font-medium duration-150 after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-full after:bg-red-900 hover:no-underline hover:opacity-60"
            href={error.link}
            target="_blank"
            rel="noreferrer"
          >
